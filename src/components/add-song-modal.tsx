  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newStory = {
        ...
        note,
        username: user?.username || username, // Use entered username if no user exists
        likes: 0,
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {user && !user.username && (
                <p className="text-amber-600 text-sm">
                  Note: You&apos;ll be posting with your wallet address since you haven&apos;t set a username yet.
                </p>
              )}
